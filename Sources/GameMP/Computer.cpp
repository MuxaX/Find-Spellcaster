...
void CGame::ComputerRender(CDrawPort *pdp)
{
  ...
  _colMedium = LCDFadedColor(SE_COL_PURPLE_LIGHT|255);
  _colDark   = LCDFadedColor(LerpColor(SE_COL_PURPLE_DARK, SE_COL_PURPLE_LIGHT, 0.5f)|255);
  _colBoxes  = LCDFadedColor(LerpColor(SE_COL_PURPLE_DARK, SE_COL_PURPLE_LIGHT, 0.5f)|255);
