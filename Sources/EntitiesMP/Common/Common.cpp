...
EffectParticlesType GetParticleEffectTypeForSurface(INDEX iSurfaceType)
{
  ...
  switch( iSurfaceType)
  {
	...
	case SURFACE_GLASS:    {eptType=EPT_BULLET_GLASS; break;}
  }
  return eptType;
}
...
BulletHitType GetBulletHitTypeForSurface(INDEX iSurfaceType)
{
  ...
  switch( iSurfaceType)
  {
	...
	case SURFACE_GLASS:    {bhtType=BHT_BRUSH_GLASS; break;}
  }
  return bhtType;
}
...
CLensFlareType _lftWhiteDustReflection;
CLensFlareType _lftOrangeGlowStar;
CLensFlareType _lftRoomGlow;
CLensFlareType _lftRoomGlowDust;
CLensFlareType _lftGlowColor;
CLensFlareType _lftSFlare;
...
void InitLensFlares(void) {
  ...
  FLARE_CREATE(_lftRoomGlow, 1, "16\\Flare16.tex", 0.0f, 180.0f, 1/10.0f, 1/10.0f, OLF_FADESIZE, 1.0f, 0.0f, 100.0f);
  
  //dust
  FLARE_CREATE(_lftRoomGlowDust, 2, "16\\Flare16.tex", 0.0f, 180.0f, 1/10.0f, 1/10.0f, OLF_FADESIZE, 1.0f, 0.0f, 100.0f);
  FLARE_GLARE(_lftRoomGlowDust, 20.0f, 0.3f, 0.8f, 1.0f);
  REFLECTION(_lftRoomGlowDust,1, "17\\DustF.tex", 1.0f,1.5f); 
  
  FLARE_CREATE(_lftGlowColor, 1, "18\\Flare18.tex", 0.0f, 180.0f, 1/10.0f, 1/10.0f, OLF_FADESIZE, 1.0f, 0.0f, 30.0f);
  
  FLARE_CREATE(_lftSFlare, 1, "19\\SFlare.tex", 0.0f, 180.0f, 1/10.0f, 1/10.0f, OLF_FADESIZE, 1.0f, 0.0f, 30.0f);
  ...
  //dust reflection
  FLARE_CREATE(_lftWhiteDustReflection, 19, "13\\Flare13.tex", 0.0f, 180.0f, 1/16.0f, 1/16.0f, OLF_FADESIZE, 7.0f, 0.5f, 128.0f);
  FLARE_GLARE(_lftWhiteDustReflection, 20.0f, 0.3f, 0.8f, 0.1f);
  REFLECTION(_lftWhiteDustReflection, 1, "14\\GrayGlow.tex", -0.5f,0.05f); 
  REFLECTION(_lftWhiteDustReflection, 2, "14\\GrayPentagram.tex", -0.25f,0.03f); 
  REFLECTION(_lftWhiteDustReflection, 3, "14\\GrayGlow1.tex", -0.05f,0.04f); 
  REFLECTION(_lftWhiteDustReflection, 4, "14\\GrayGlow1.tex", 0.3f,0.02f); 
  REFLECTION(_lftWhiteDustReflection, 5, "14\\GrayPentagram.tex", 0.5f,0.05f); 
  REFLECTION(_lftWhiteDustReflection, 6, "14\\DarkGrayPentagram.tex", 0.8f,0.04f); 
  REFLECTION(_lftWhiteDustReflection, 7, "14\\LittleGrayPentagram.tex", 1.2f,0.02f); 
  REFLECTION(_lftWhiteDustReflection, 8, "14\\DarkGrayPentagram.tex", 1.24f,0.03f); 
  REFLECTION(_lftWhiteDustReflection, 9, "14\\GrayGlow.tex", 1.4f,0.06f); 
  REFLECTION(_lftWhiteDustReflection,10, "14\\GrayGlow1.tex", 1.5f,0.02f); 
  REFLECTION(_lftWhiteDustReflection,11, "14\\GrayPentagram.tex", 1.64f,0.05f); 
  REFLECTION(_lftWhiteDustReflection,12, "14\\LittleGrayPentagram.tex", 1.7f,0.05f); 
  REFLECTION(_lftWhiteDustReflection,13, "14\\GrayPentagram.tex", 1.8f,0.06f); 
  REFLECTION(_lftWhiteDustReflection,14, "14\\GrayGlow.tex", 2.0f,0.06f); 
  REFLECTION(_lftWhiteDustReflection,15, "14\\GrayGlow1.tex", 2.1f,0.015f); 
  REFLECTION(_lftWhiteDustReflection,16, "14\\GrayPentagram.tex", 2.4f,0.05f); 
  REFLECTION(_lftWhiteDustReflection,17, "14\\DarkGrayPentagram.tex", 2.8f,0.03f); 
  REFLECTION(_lftWhiteDustReflection,18, "14\\DarkGrayPentagram1.tex", 1.0f,1.5f); 
  
  //Orange glow star
  FLARE_CREATE(_lftOrangeGlowStar, 1, "15\\Flare15.tex", 0.0f, 180.0f, 1/5.0f, 1/5.0f, OLF_FADESIZE, 7.0f, 0.5f, 5.0f);
  //FLARE_GLARE(_lftOrangeGlowStar, 20.0f, 0.3f, 0.8f, 1.0f);
  
  //FLARE_CREATE(_lftWhiteGlowStarNG, 1, "15\\Flare15.tex", 0.0f, 180.0f, 1/5.0f, 1/5.0f, OLF_FADESIZE, 7.0f, 0.5f, 5.0f);
};
...
void CloseLensFlares(void) {
  ...
  _lftWhiteDustReflection.lft_aolfFlares.Clear();
  _lftOrangeGlowStar.lft_aolfFlares.Clear();
  _lftRoomGlow.lft_aolfFlares.Clear();
  _lftRoomGlowDust.lft_aolfFlares.Clear();
  _lftGlowColor.lft_aolfFlares.Clear();
  _lftSFlare.lft_aolfFlares.Clear();
};
