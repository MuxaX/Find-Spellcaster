...
#define MAX_PISTOL INDEX(140)
#define MAX_SMG    INDEX(500)
...
#define AV_PISTOL         INDEX(50)
#define AV_SMG            INDEX(10)
...
extern CLensFlareType _lftWhiteDustReflection;
extern CLensFlareType _lftOrangeGlowStar;
extern CLensFlareType _lftRoomGlow;
extern CLensFlareType _lftRoomGlowDust;
extern CLensFlareType _lftGlowColor;
extern CLensFlareType _lftSFlare;
