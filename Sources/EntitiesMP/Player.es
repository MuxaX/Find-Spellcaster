...
properties:
 ...
 168 FLOAT m_tmSeriousDamageMax   = 30.0f,
 169 FLOAT m_tmSeriousSpeedMax    = 30.0f,
 ...
 //shake bullet
 193 FLOAT m_tmBulletShakeEnd = 0.0f,
 194 FLOAT m_fBulletShakeStrengthX = 1.0f,
 195 FLOAT m_fBulletShakeStrengthY = 1.0f,
...
//232 texture TEXTURE_BLOOD_MANY   "TexturesMP\\Interface\\Blood3.tex",
 ...
 ************************************************************/
  ...
  void RenderPlayerView(CDrawPort *pdp, BOOL bShowExtras)
  {
    ...
    // do screen blending
    ULONG ulR=255, ulG=255, ulB=255; // red for wounding
	...
	/*Switch texture arm*/
	 ...
	 //CPrintF("m_strLastTarget = %s\n", GetPlayerWeapons()->m_strLastTarget);
	 //CPrintF("tmDelta = %f\n", tmDelta);
...
//    CPrintF("---APPLY: %g\n", paOriginal.pa_aRotation(1));
  ...
  void ButtonsActions( CPlayerAction &paAction)
  {
    ...
    // if fire is released
    if (ulReleasedButtons&PLACT_FIRE /*|| ulReleasedButtons&PLACT_ALTFIRE*/) {
	...
	// if alternative fire is pressed
