...
EP_ENUMBEG(BasicEffectType)
  ...
  EP_ENUMVALUE(BET_LASERBLUE, "Laserwave blue"),
  EP_ENUMVALUE(BET_BULLETSTAINGLASS, "Bullet stain glass"),
  EP_ENUMVALUE(BET_BULLETSTAINGLASSNOSOUND, "Bullet stain glass sound"),
...
#define MODEL_BULLET_GLASS ((0x00000259<<8)+72)
 CEntityComponent(ECT_MODEL, MODEL_BULLET_GLASS, "EFNM" "Models\\Effects\\BulletGlass\\BulletGlass.mdl"),
#define TEXTURE_BULLET_GLASS ((0x00000259<<8)+73)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BULLET_GLASS, "EFNM" "Models\\Effects\\BulletGlass\\CrackedGlass_01.tex"),
...
#define SOUND_BULLET_GLASS ((0x00000259<<8)+98)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_GLASS, "EFNM" "Sounds\\Weapons\\BulletHitGlass.wav"),
...
#define TEXTURE_LASERBLUE ((0x00000259<<8)+110)
 CEntityComponent(ECT_TEXTURE, TEXTURE_LASERBLUE, "EFNM" "Models\\Effects\\ShockWaveGreen\\ShockWaveBlue.tex"),
};
