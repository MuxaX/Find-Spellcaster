...
EP_ENUMBEG(WeaponItemType)
  ...
  EP_ENUMVALUE(WIT_DOUBLECOLT, "P90"),
...
#define MODEL_SNIPER ((0x00000322<<8)+110)
 CEntityComponent(ECT_MODEL, MODEL_SNIPER, "EFNM" "ModelsMP\\Weapons\\Sniper\\SniperItem.mdl"),
