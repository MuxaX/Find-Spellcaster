...
#line 2 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
...
#line 39 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
const CTString & CTacticsHolder::GetDescription(void)const {
#line 40 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
return m_strDescription ;
#line 41 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
}
BOOL CTacticsHolder::
#line 44 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
...
#line 46 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
InitAsEditorModel  ();
#line 47 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
SetPhysicsFlags  (EPF_MODEL_IMMATERIAL );
#line 48 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
SetCollisionFlags  (ECF_IMMATERIAL );
#line 51 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
SetModel  (MODEL_MANAGER );
#line 52 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
SetModelMainTexture  (TEXTURE_MANAGER );
#line 54 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
...
#line 55 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
...
#line 56 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
{case(EVENTCODE_ETrigger):{const ETrigger&e= (ETrigger&)__eeInput;

#line 58 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
m_tmLastActivation  = _pTimer  -> CurrentTick  ();
#line 59 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
UnsetTimer();Jump(STATE_CURRENT,0x00eb0001, FALSE, EInternal());return TRUE;
#line 60 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
}ASSERT(FALSE);break;default:{
#line 62 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
return TRUE;
#line 63 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
}ASSERT(FALSE);break;
#line 64 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
}return TRUE;}BOOL CTacticsHolder::H0x00eb0001_Main_02(const CEntityEvent &__eeInput){
ASSERT(__eeInput.ee_slEvent==EVENTCODE_EInternal);
#undef STATE_CURRENT
#define STATE_CURRENT 0x00eb0001
;
#line 67 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
SetTimerAfter(0.1f);
...
#line 68 "V:/Programs/SamSDK/Sources/EntitiesMP/TacticsHolder.es"
