...
EP_ENUMBEG(ProjectileType)
  ...
  EP_ENUMVALUE(PRT_ALT_GRANAT, "AltGrenade"),
  EP_ENUMVALUE(PRT_LASER_BLUE, "LaserBlue"),
...
#define MODEL_LASER_BLUE ((0x000001f5<<8)+53)
 CEntityComponent(ECT_MODEL, MODEL_LASER_BLUE, "EFNM" "Models\\Weapons\\Cannon\\Projectile\\BallLighting.mdl"),
#define TEXTURE_LASER_BLUE ((0x000001f5<<8)+54)
 CEntityComponent(ECT_TEXTURE, TEXTURE_LASER_BLUE, "EFNM" "Models\\Weapons\\Cannon\\Projectile\\BallLighting.tex"),
...
#define MODEL_ALT_GRENADE ((0x000001f5<<8)+222)
 CEntityComponent(ECT_MODEL, MODEL_ALT_GRENADE, "EFNM" "Models\\Weapons\\TommyGun\\ag36GRANAT.mdl"),
#define TEXTURE_ALT_GRENADE ((0x000001f5<<8)+223)
 CEntityComponent(ECT_TEXTURE, TEXTURE_ALT_GRENADE, "EFNM" "Models\\Weapons\\TommyGun\\Body.tex"),
};
