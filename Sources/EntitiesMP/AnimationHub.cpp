...
#line 2 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 58 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
((CTString &) m_strDescription ) . PrintF  ("-><none>");
#line 59 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
if(m_penTarget0  != NULL ){
#line 60 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
((CTString &) m_strDescription ) . PrintF  ("->%s..." , m_penTarget0  -> GetName  ());
#line 61 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}
#line 62 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
return m_strDescription ;
#line 63 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}
BOOL CAnimationHub::
...
#line 69 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_iCounter  = 0;
#line 70 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 72 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
FLOAT fDelay  = m_tmDelayEach  + (& m_tmDelay0 ) [ m_iCounter  ];
#line 74 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
if(!(fDelay  > 0)){ Jump(STATE_CURRENT,0x00e40003, FALSE, EInternal());return TRUE;}
#line 76 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 80 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
CEntity  * penTarget  = (& m_penTarget0 ) [ m_iCounter  ];
#line 82 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
if(penTarget  == NULL ){
#line 84 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
Jump(STATE_CURRENT, STATE_CAnimationHub_WaitChange, TRUE, EVoid());return TRUE;
#line 85 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}
#line 87 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
EChangeAnim  eca ;
#line 88 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . iModelAnim  = m_iModelAnim ;
#line 89 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . bModelLoop  = m_bModelLoop ;
#line 90 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . iTextureAnim  = m_iTextureAnim ;
#line 91 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . bTextureLoop  = m_bTextureLoop ;
#line 92 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . iLightAnim  = m_iLightAnim ;
#line 93 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . bLightLoop  = m_bLightLoop ;
#line 94 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . colAmbient  = m_colAmbient ;
#line 95 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
eca  . colDiffuse  = m_colDiffuse ;
#line 96 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
penTarget  -> SendEvent  (eca );
#line 98 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_iCounter  ++;Jump(STATE_CURRENT,0x00e40004, FALSE, EInternal());return TRUE;
#line 99 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}BOOL CAnimationHub::H0x00e40005_RelayEvents_05(const CEntityEvent &__eeInput) {
ASSERT(__eeInput.ee_slEvent==EVENTCODE_EInternal);
#undef STATE_CURRENT
#define STATE_CURRENT 0x00e40005

#line 101 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 107 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 108 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 110 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_iModelAnim  = eca  . iModelAnim ;
#line 111 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_bModelLoop  = eca  . bModelLoop ;
#line 112 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_iTextureAnim  = eca  . iTextureAnim ;
#line 113 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_bTextureLoop  = eca  . bTextureLoop ;
#line 114 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_iLightAnim  = eca  . iLightAnim ;
#line 115 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_bLightLoop  = eca  . bLightLoop ;
#line 116 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_colAmbient  = eca  . colAmbient ;
#line 117 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
m_colDiffuse  = eca  . colDiffuse ;
#line 118 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
Jump(STATE_CURRENT, STATE_CAnimationHub_RelayEvents, TRUE, EVoid());return TRUE;
#line 119 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}ASSERT(FALSE);break;default: return FALSE; break;
#line 120 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 121 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
...
#line 126 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
InitAsEditorModel  ();
#line 127 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
SetPhysicsFlags  (EPF_MODEL_IMMATERIAL );
#line 128 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
SetCollisionFlags  (ECF_IMMATERIAL );
#line 131 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
SetModel  (MODEL_HUB );
#line 132 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
SetModelMainTexture  (TEXTURE_HUB );
#line 135 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
for(INDEX i  = 0;i  < 10;i  ++){
#line 136 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
CEntityPointer & penTarget  = (& m_penTarget0 ) [ i  ];
#line 137 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
if(penTarget  != NULL  && 
#line 138 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
! IsOfClass  (penTarget  , "ModelHolder2") && 
#line 139 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
! IsOfClass  (penTarget  , "Light")){
#line 140 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
WarningMessage  ("All targets must be ModelHolder2 or Light!");
#line 141 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
penTarget  = NULL ;
#line 142 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}
#line 143 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
}
#line 144 "V:/Programs/SamSDK/Sources/EntitiesMP/AnimationHub.es"
