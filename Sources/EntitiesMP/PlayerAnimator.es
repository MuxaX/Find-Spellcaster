...
// ************** COLT **************
 ...
 300 model  MODEL_P90                   "Models\\Weapons\\P90\\P90Item.mdl",
...
// ************** TOMMYGUN **************
 ...
 74 model   MODEL_UNDERBARREL           "Models\\Weapons\\TommyGun\\af36UndetBarrel.mdl",
 75 model   MODEL_AGGRANAT              "Models\\Weapons\\TommyGun\\ag36GRANAT.mdl",
...
113 model   MODEL_SNIPER_SHUTTER        "ModelsMP\\Weapons\\Sniper\\SniperShutter.mdl",
  ...
  void SetWeapon(void) {
    ...
    // *********** MINIGUN ***********
      case WEAPON_MINIGUN:
        ...
        //AddWeaponAttachment(MINIGUNITEM_ATTACHMENT_ENGINE, MODEL_MG_ENGINE, TEXTURE_MG_BODY, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);      
  ...
  void FireAnimation(INDEX iAnim, ULONG ulFlags) {
    if (m_bSwim) {
      ...
      switch (iWeapon) {
        case WEAPON_NONE:
          break;
        case WEAPON_KNIFE: case WEAPON_COLT:  //case WEAPON_PIPEBOMB:
