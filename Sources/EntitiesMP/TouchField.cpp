...
#line 2 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 7 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 50 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
{
#line 51 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
m_fsField  . fs_toTexture  . SetData  (GetTextureDataForComponent  (TEXTURE_FIELD ));
#line 52 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
m_fsField  . fs_colColor  = C_WHITE  | CT_OPAQUE ;
#line 53 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
  
#line 55 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
CFieldSettings * CTouchField::GetFieldSettings(void) {
#line 56 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(m_fsField  . fs_toTexture  . GetData  () == NULL ){
#line 57 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SetupFieldSettings  ();
#line 58 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 59 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
return & m_fsField ;
#line 60 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
  
#line 64 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SLONG CTouchField::GetUsedMemory(void) 
#line 65 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
{
#line 67 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SLONG  slUsedMemory  = sizeof  (CTouchField ) - sizeof  (CRationalEntity ) + CRationalEntity  :: GetUsedMemory  ();
#line 69 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
slUsedMemory  += m_strName  . Length  ();
#line 70 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
return slUsedMemory ;
#line 71 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
BOOL CTouchField::
...
#line 78 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
m_bActive  = TRUE ;
#line 79 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 86 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(m_bBlockNonPlayers  && IsOfClass  (ep  . penOther  , "Projectile"))
#line 87 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
{
#line 88 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(! IsOfClass  (((CProjectile  *) & * ep  . penOther ) -> m_penLauncher  , "Player")){
#line 89 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
EPass  epass ;
#line 90 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
epass  . penOther  = this ;
#line 91 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
ep  . penOther  -> SendEvent  (epass );
#line 92 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 93 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 96 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(m_bPlayersOnly  && ! IsDerivedFromClass  (ep  . penOther  , "Player")){
#line 98 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
return TRUE;
#line 99 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 102 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SendToTarget  (m_penEnter  , m_eetEnter  , ep  . penOther );
#line 104 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(m_tmExitCheck  > 0){
#line 106 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
m_penLastIn  = ep  . penOther ;
#line 108 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
Jump(STATE_CURRENT, STATE_CTouchField_WaitingExit, TRUE, EVoid());return TRUE;
#line 109 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 110 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
return TRUE;
#line 111 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}ASSERT(FALSE);break;default: return FALSE; break;
#line 112 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 117 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 119 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 124 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
CEntity  * penNewIn ;
#line 125 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(m_bPlayersOnly ){
#line 126 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
penNewIn  = TouchingEntity  (ConsiderPlayers  , m_penLastIn );
#line 127 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}else {
#line 128 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
penNewIn  = TouchingEntity  (ConsiderAll  , m_penLastIn );
#line 129 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 131 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(penNewIn  == NULL ){
#line 133 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SendToTarget  (m_penExit  , m_eetExit  , m_penLastIn );
#line 135 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
Jump(STATE_CURRENT, STATE_CTouchField_WaitingEntry, TRUE, EVoid());return TRUE;
#line 136 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 137 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
m_penLastIn  = penNewIn ;
#line 138 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
UnsetTimer();Jump(STATE_CURRENT,0x00ce0005, FALSE, EInternal());return TRUE;
#line 139 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}ASSERT(FALSE);break;default: return FALSE; break;
#line 140 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 141 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 146 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
m_bActive  = FALSE ;
#line 147 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SetTimerAt(THINKTIME_NEVER);
...
#line 150 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
...
#line 155 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
InitAsFieldBrush  ();
#line 156 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SetPhysicsFlags  (EPF_BRUSH_FIXED );
#line 157 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(! m_bBlockNonPlayers ){
#line 158 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SetCollisionFlags  (((ECBI_MODEL ) << ECB_TEST ) | ((ECBI_BRUSH ) << ECB_IS ) | ((ECBI_MODEL ) << ECB_PASS ));
#line 159 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}else {
#line 160 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
SetCollisionFlags  (((ECBI_MODEL  | ECBI_PLAYER  | ECBI_PROJECTILE_SOLID  | ECBI_PROJECTILE_MAGIC ) << ECB_TEST ) 
#line 161 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
| ((ECBI_BRUSH ) << ECB_IS ) | ((ECBI_PLAYER  | ECBI_PROJECTILE_SOLID  | ECBI_PROJECTILE_MAGIC ) << ECB_PASS ));
#line 162 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 164 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
if(m_bActive ){
#line 165 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
Jump(STATE_CURRENT, STATE_CTouchField_WaitingEntry, TRUE, EVoid());return TRUE;
#line 166 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}else {
#line 167 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
Jump(STATE_CURRENT, STATE_CTouchField_Frozen, TRUE, EVoid());return TRUE;
#line 168 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
}
#line 170 "V:/Programs/SamSDK/Sources/EntitiesMP/TouchField.es"
