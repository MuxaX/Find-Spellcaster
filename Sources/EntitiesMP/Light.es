...
enum LensFlareType {                
  ...
  13 LFT_WHITE_DUST_REFLECTIONS       "White dust reflections",
  14 LFT_ORANGE_GLOW_FAR              "Orange glow star",
  15 LFT_ROOM_GLOW                    "Room glow",
  16 LFT_ROOM_GLOW_DUST               "Room glow dust",
  17 LFT_GLOW_COLOR                   "Glow color",
  18 LFT_SFLARE                       "SFlare"
};
