...
CEntityProperty CAmmoPack_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x00000326<<8)+18, offsetof(CAmmoPack, m_iPistol), "Pistols", 'T', 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x00000326<<8)+19, offsetof(CAmmoPack, m_iSMG), "SMG", 'Q', 0x7F0000FFUL, 0),
