...
#define SHADER_MAIN(name) extern "C" void _declspec(dllexport) Shader_##name (void)
#define SHADER_DESC(name,x) extern "C" void _declspec(dllexport) Shader_Desc_##name (x)
