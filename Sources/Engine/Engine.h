...
ENGINE_API CTString _strEngineBuild;  // not valid before InitEngine()!
ENGINE_API ULONG _ulEngineBuildMajor;
ENGINE_API ULONG _ulEngineBuildMinor;

ENGINE_API BOOL _bDedicatedServer;
ENGINE_API BOOL _bWorldEditorApp; // is this world edtior app
