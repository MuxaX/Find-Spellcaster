...
static struct AmmoInfo _aaiAmmo[9] = {
  { &_toAPistol,        &_awiWeapons[2],  NULL,             0, 0, 0, -9, FALSE }, //  0
  { &_toAShells,        &_awiWeapons[4],  &_awiWeapons[5],  0, 0, 0, -9, FALSE }, //  1
  { &_toABullets,       &_awiWeapons[6],  &_awiWeapons[7],  0, 0, 0, -9, FALSE }, //  2
  { &_toARockets,       &_awiWeapons[8],  NULL,             0, 0, 0, -9, FALSE }, //  3
  { &_toAGrenades,      &_awiWeapons[9],  NULL,             0, 0, 0, -9, FALSE }, //  4
  { &_toANapalm,        &_awiWeapons[11], NULL,             0, 0, 0, -9, FALSE }, //  5
  { &_toAElectricity,   &_awiWeapons[12], NULL,             0, 0, 0, -9, FALSE }, //  6
  { &_toAIronBall,      &_awiWeapons[14], NULL,             0, 0, 0, -9, FALSE }, //  7
  { &_toASniperBullets, &_awiWeapons[13], NULL,             0, 0, 0, -9, FALSE }, //  8
};
...
struct WeaponInfo _awiWeapons[18] = {
  ...
  { WEAPON_SINGLESHOTGUN,   &_toWSingleShotgun,   &_aaiAmmo[1], FALSE },   //  4
  { WEAPON_DOUBLESHOTGUN,   &_toWDoubleShotgun,   &_aaiAmmo[1], FALSE },   //  5
  { WEAPON_TOMMYGUN,        &_toWTommygun,        &_aaiAmmo[2], FALSE },   //  6
  { WEAPON_MINIGUN,         &_toWMinigun,         &_aaiAmmo[2], FALSE },   //  7
  { WEAPON_ROCKETLAUNCHER,  &_toWRocketLauncher,  &_aaiAmmo[3], FALSE },   //  8
  { WEAPON_GRENADELAUNCHER, &_toWGrenadeLauncher, &_aaiAmmo[4], FALSE },   //  9
  { WEAPON_CHAINSAW,        &_toWChainsaw,        NULL,         FALSE },   // 10
  { WEAPON_FLAMER,          &_toWFlamer,          &_aaiAmmo[5], FALSE },   // 11
  { WEAPON_LASER,           &_toWLaser,           &_aaiAmmo[6], FALSE },   // 12
  { WEAPON_SNIPER,          &_toWSniper,          &_aaiAmmo[8], FALSE },   // 13
  { WEAPON_IRONCANNON,      &_toWIronCannon,      &_aaiAmmo[7], FALSE },   // 14
...
static void FillWeaponAmmoTables(void)
{
  ...
  _aaiAmmo[2].ai_iAmmoAmmount    = _penWeapons->m_iBullets;
  _aaiAmmo[2].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxBullets;
  _aaiAmmo[2].ai_iMagazinAmmo    = _penWeapons->m_iBulletsMagazin;
  _aaiAmmo[3].ai_iAmmoAmmount    = _penWeapons->m_iRockets;
  _aaiAmmo[3].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxRockets;
  _aaiAmmo[4].ai_iAmmoAmmount    = _penWeapons->m_iGrenades;
  _aaiAmmo[4].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxGrenades;
  _aaiAmmo[5].ai_iAmmoAmmount    = _penWeapons->m_iNapalm;
  _aaiAmmo[5].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxNapalm;
  _aaiAmmo[6].ai_iAmmoAmmount    = _penWeapons->m_iElectricity;
  _aaiAmmo[6].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxElectricity;
  _aaiAmmo[7].ai_iAmmoAmmount    = _penWeapons->m_iIronBalls;
  _aaiAmmo[7].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxIronBalls;
  _aaiAmmo[8].ai_iAmmoAmmount    = _penWeapons->m_iSniperBullets;
  _aaiAmmo[8].ai_iMaxAmmoAmmount = _penWeapons->m_iMaxSniperBullets;
